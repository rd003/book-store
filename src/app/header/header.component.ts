  ...
  template: `
    <mat-toolbar color="primary">
      ...
      <div style="display: flex;gap:4px;margin-left:10px">
        <button class="nav-link active" mat-button>🏠Home</button>
        <button class="nav-link" mat-button>📚Books</button>
      </div>
      <span class="example-spacer"></span>
      <button mat-icon-button  class="mx-2" color="secondary"> 
         <mat-icon matBadge="8" matBadgePosition="above after" matBadgeColor="accent">shopping_cart</mat-icon>
      </button>
